...
Emergency care is the most expensive routine setting in the system (ED attendance unit costs in the £250–£400 range per National Cost Collection / PSSRU figures; an emergency admission is thousands), and ED crowding cascades into ambulance delays and canceled electives. Anything that safely resolves demand upstream — self-care advice, same-day primary care, community response — buys the system capacity at its most stressed point. This is the standard benefit line for symptom checkers, 111-style triage services, and [remote patient monitoring](../remote-patient-monitoring-economics/).
...
- **Valuing attendances at average cost** when ED fixed costs don't fall — see [marginal vs average cost](../marginal-vs-average-cost/).
