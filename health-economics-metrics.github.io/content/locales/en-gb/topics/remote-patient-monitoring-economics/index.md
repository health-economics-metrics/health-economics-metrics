...
A compliant patient-month stacks to roughly **$90–130 PMPM**. On the cost-offset side, hospital-at-home programmes (CMS Acute Hospital Care at Home waiver: 300+ hospitals) show ~$1,800–$3,000 saved per encounter versus inpatient care with lower readmissions and infections — the clearest demonstration that monitoring plus virtual care can substitute for the most expensive resource in the system, the staffed bed.
...
A US practice enrols 400 hypertension patients; 70% meet the 16-day threshold in a typical month; management minutes logged for 60%:
...
- **Offset claims at average cost** for admissions whose fixed costs remain (see [marginal vs average cost](../marginal-vs-average-cost/)).
- **Monitoring-team saturation**: alert volume scales with enrolment; the staffing line is the binding constraint most models omit.
