...
SROI extends [ROI](../return-on-investment/) to outcomes that markets don't price — wellbeing, social connection, environmental impact — by monetizing them with financial proxies, for *all* stakeholders affected.
