...
A comprehensive introduction to health economics maths, examples, and reasoning, written for software engineers building for national health service organizations worldwide. Each file covers one metric or concept: definition, why it matters, the maths, a worked example, the software engineering connection, pitfalls, and sources.
