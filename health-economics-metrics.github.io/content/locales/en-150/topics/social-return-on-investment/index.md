...
SROI extends [ROI](../return-on-investment/) to outcomes that markets don't price — wellbeing, social connection, environmental impact — by monetising them with financial proxies, for *all* stakeholders affected.
...
```
SROI ratio = PV(monetised social outcomes) / PV(investment)
...
A befriending app connecting isolated older adults to volunteers; programme cost £200,000/year; 1,500 active pairs.
...
SROI is the honest framework for engineering work whose beneficiaries are outside the paying team: open-source maintenance, accessibility improvements, platform work consumed by other teams, developer-community investment. The transferable mechanics: identify all stakeholders, monetise with stated proxies, and apply deadweight/attribution discounts (would that OSS fix have happened anyway? how much of the gain is your work vs the ecosystem's?). The discipline of *discounting your own impact claims* is what separates SROI from a marketing number.
