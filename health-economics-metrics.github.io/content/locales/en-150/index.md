...
A comprehensive introduction to health economics maths, examples, and reasoning, written for software engineers building for national health service organisations worldwide. Each file covers one metric or concept: definition, why it matters, the maths, a worked example, the software engineering connection, pitfalls, and sources.
...
- [Cost-minimisation analysis (CMA)](locales/en-gb-oxendict/topics/cost-minimization-analysis/) — cheapest option, after proving equivalence
...
- [Downstream resource optimisation](locales/en-gb-oxendict/topics/downstream-resource-optimization/) — unblocking the role everyone waits on
...
- [Hard cash-releasing savings (deficit defence)](locales/en-gb-oxendict/topics/hard-cash-releasing-savings-deficit-defence/) — deleting budget lines; the CFO's metric
...
- [Flow metrics](locales/en-gb-oxendict/topics/flow-metrics/) — Little's Law, WIP, flow efficiency; the shared queueing maths of hospitals and pipelines
- [WSJF and CD3](locales/en-gb-oxendict/topics/wsjf-and-cd3/) — value-density prioritisation; the backlog as a QALY league table
...
- [Inference unit economics](locales/en-gb-oxendict/topics/inference-unit-economics/) — cost per token, and modelling relentless price decline
