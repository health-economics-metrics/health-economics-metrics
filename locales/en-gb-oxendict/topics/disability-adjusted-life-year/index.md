...
- Digital health aimed at global health funders (Gavi, Global Fund, national programmes) should express impact as **cost per DALY averted** — it is the metric grant reviewers already think in.
...
- **Using GDP-multiple thresholds as a rubber stamp** — WHO itself warns they ignore budgets and opportunity cost; see [willingness-to-pay thresholds](../willingness-to-pay-thresholds/).
- **Claiming population-scale DALYs from per-user efficacy** without multiplying through uptake and adherence — see [reach and equity](../reach-and-equity/).
