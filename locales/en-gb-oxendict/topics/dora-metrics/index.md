...
- **Optimizing one metric**: speed without CFR/reliability is the throughput-instability trade-off — always report the four together (they are a [cost-consequence table](../cost-consequence-analysis/), not a score).
