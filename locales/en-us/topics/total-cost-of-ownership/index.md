...
```
TCO = initial cost (build/license + integration + data migration + training)
...
Year 0 (license/build)  £250,000        £900,000
...
- **Free-internal-labor fallacy**: in-house maintenance costed at zero because "the team's already paid" — see [opportunity cost](../opportunity-cost/).
