...
EQ-5D is the EuroQol group's standardised questionnaire for measuring health-related quality of life. It is the instrument that produces the utility weights inside most [QALY](../quality-adjusted-life-year/) calculations — NICE's reference case names it the preferred measure for adults.
...
- **Design lesson**: EQ-5D shows how a tiny standardised survey plus a published scoring function yields a comparable single index. That's the pattern for any credible developer-experience index too — standardised instrument, published weights, not ad-hoc vibes. See [SPACE and DevEx](../space-and-devex/).
