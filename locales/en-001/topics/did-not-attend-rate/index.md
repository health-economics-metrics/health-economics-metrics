...
- **Prediction ethics preview**: no-show models trained on attendance data encode deprivation and access barriers; using them to *deprioritise* likely non-attenders amplifies inequity, using them to *support* attendance (transport help, telephone alternatives) reduces it. See [reach and equity](../reach-and-equity/).
