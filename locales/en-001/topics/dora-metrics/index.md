...
Reliability   → benefit discount: a service at 99% availability delivers ≈ 0.99
                of its modelled benefit — the software analogue of adherence
```
...
- **Optimising one metric**: speed without CFR/reliability is the throughput-instability trade-off — always report the four together (they are a [cost-consequence table](../cost-consequence-analysis/), not a score).
