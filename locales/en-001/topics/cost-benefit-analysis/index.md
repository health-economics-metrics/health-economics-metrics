...
CBA values both costs *and* outcomes in money. It is the only analysis type that can answer "is this worth doing at all?" — not merely "which option is best?" — because monetised benefits can be compared directly against costs.

## Why it matters

CBA is the standard of the UK's HM Treasury **Green Book** for all public spending appraisal, health included when outcomes can be monetised. Where [CEA](../cost-effectiveness-analysis/)/[CUA](../cost-utility-analysis/) stop at "cost per unit of health," CBA prices the health itself (QALY × threshold value) and everything else — time, travel, carbon — and reports one net figure. Every full NHS digital business case contains a CBA-shaped economic case.
...
Health effects can enter monetised as QALYs × λ (see [willingness-to-pay thresholds](../willingness-to-pay-thresholds/)). The Green Book also mandates **optimism-bias adjustments** — uplifting cost estimates and haircutting benefits by evidence-based percentages, because appraisals are systematically rosy.
...
- **Monetise the dominant benefit honestly or not at all** — patient/user time is monetised at defensible rates; "brand value" is not.
- **NPV ranks, BCR doesn't**: a tiny project with BCR 5 can matter less than a big one with BCR 1.6.

## Pitfalls

- **Monetising the unmonetisable** to inflate benefits (morale, "strategic alignment") — keep those qualitative, per [cost-consequence analysis](../cost-consequence-analysis/).
- **Counting transfers as benefits**: money moving between public bodies nets to zero at the societal [perspective](../analysis-perspective/).
