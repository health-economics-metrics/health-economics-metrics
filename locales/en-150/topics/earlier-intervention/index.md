...
The probability weighting is essential: not every waiting patient progresses. Model the transition probability per unit time (from natural-history data), not the worst case. Then discount: costs avoided years away are worth less today ([discounting](../discounting-and-time-preference/)) — and note most early intervention is cost-*effective* rather than cost-*saving* (see [prevention economics](../prevention-economics/)).
